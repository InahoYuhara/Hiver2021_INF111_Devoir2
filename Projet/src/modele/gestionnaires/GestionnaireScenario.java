...
public class GestionnaireScenario {
	...
	ArrayList<String> numeroCriminel = new ArrayList<String>(GestionnaireReseau.getInstance().NB_CRIMINELS);
	ArrayList<String> numeroStandard = new ArrayList<String>(GestionnaireReseau.getInstance().NB_CELLULAIRES);
